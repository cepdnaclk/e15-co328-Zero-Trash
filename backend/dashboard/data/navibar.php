<div class="w3-display-container w3-top w3-card-2">
   <div class="w3-bar w3-theme w3-large">
      ...
      <span class="w3-bar-item w3-large w3-padding-12 w3-hide-small">Collector - Dashboard</span>
      ...
      <div class="w3-right w3-dropdown-click">
         ...
         <div class="w3-container">
            <div class="w3-row">
               <div class="w3-col s4">
                  <?php
                  echo "<img src='../img/profile/userIcon.png' class='w3-responsive w3-padding-12' style='width: 80%;'>";
                  ?>
               </div>
               <div class="w3-col s8 w3-padding-4 w3-left-align">
                  ...
                  <p>
                     <!--<a href="#" class="app-link">Settings</a>-->
                     <!--<a href="#" class="app-link">Messages</a>-->
                  </p>
               </div>
            </div>
         </div>
