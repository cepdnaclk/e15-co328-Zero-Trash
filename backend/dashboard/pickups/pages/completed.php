...
<table class="w3-table w3-hoverable w3-striped w3-border">
   ...
   <?php
   $c = $pickups->listPickupsByState('COMPLETED', $f, $l);
   ...
   for ($i = 0; $i < sizeof($c); $i++) {
      ...
      $rating = $c[$i]['rating'];
      print "<tr><td>$customer</td> <td>$region</td> <td>$placedOn</td> <td>$collector</td> <td>$rating</td> </tr>";
   }
   ?>
</table>
...
<div class="w3-container w3-center">
   <div class="w3-bar w3-border" style="width: 200px;">
      <?php
      $c = $pickups->countPickupsByState('COMPLETED');
      //echo $c;
